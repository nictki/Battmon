...
if __name__ == '__main__':
    ...
    def set_sound_volume_level(volume_value):
        ...
        if volume_value > internal_config.MAX_SOUND_VOLUME_LEVEL:
            raise argparse.ArgumentError(volume_value, "Sound level can't be greater then %s" % internal_config.MAX_SOUND_VOLUME_LEVEL)
        return volume_value
    ...
    # let's go
    ml = battery_monitor.Monitor(**vars(args))
    ml.run_main_loop()
